...
namespace Banciu_Adrian_Lab2.Data
{
    public class Banciu_Adrian_Lab2Context : DbContext
    {
        ...
        public DbSet<Banciu_Adrian_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Banciu_Adrian_Lab2.Models.BookCategory> BookCategory { get; set; }
        public DbSet<Banciu_Adrian_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Banciu_Adrian_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
